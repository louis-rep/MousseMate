...
or one where the OSM sync burned the first sequence ids), a manual "Unknown bar"
placeholder is inserted as id 1. osm_type="manual" marks it as not OSM-owned so
the sync script never closes it.
